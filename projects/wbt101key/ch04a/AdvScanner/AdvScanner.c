 ...
 * Function Prototypes
 ******************************************************************/
static void                  advscanner_app_init               ( void );
...
void dump(uint32_t arg)
{
    WICED_BT_TRACE("Started dump thread\n");
    while(1)
    {
...
void newAdv(wiced_bt_ble_scan_results_t *p_scan_result, uint8_t *p_adv_data)
{
    ...
    (void)dt_addDevice(p_scan_result,p_adv_data);

}

static wiced_thread_t *myThread;
/*
 * This function is executed in the BTM_ENABLED_EVT management callback.
 */
void advscanner_app_init(void)
{
    wiced_bt_ble_scan(BTM_BLE_SCAN_TYPE_HIGH_DUTY,FALSE,newAdv);

    myThread = wiced_rtos_create_thread();
    wiced_rtos_init_thread(myThread,4,"dump",dump,1000,0);
