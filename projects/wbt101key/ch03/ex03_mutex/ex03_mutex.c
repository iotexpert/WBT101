/* Use two different threads to blink the same LED.
 * Each of the 2 buttons cause the LED to blink at
 * different rates. Try with and without the mutex
 * to see what happens when both buttons are held.
 * */
