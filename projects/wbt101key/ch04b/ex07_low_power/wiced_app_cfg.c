...
const wiced_bt_cfg_settings_t wiced_app_cfg_settings =
{
    ...
    .ble_advert_cfg =                                                                                /* BLE advertisement settings */
    {
        ...
        .high_duty_min_interval          = 160,                                                      /* High duty undirected connectable minimum advertising interval 48 *0.625 = 30ms */
        ...
        .low_duty_directed_min_interval  = 160,                                                      /* Low duty directed connectable minimum advertising interval */
        .low_duty_directed_max_interval  = 160,                                                      /* Low duty directed connectable maximum advertising interval */
