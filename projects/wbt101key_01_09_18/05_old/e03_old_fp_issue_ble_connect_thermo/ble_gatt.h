...
#define WICED_DEVICE_NAME           ("GJL_BLE_CONNECT")
...
typedef enum
{
    ...
    HANDLE_THERMOMETER_SERVICE = 0x20,
        HANDLE_THERMOMETER_SERVICE_CHAR_MEASUREMENT,
        HANDLE_THERMOMETER_SERVICE_CHAR_MEASUREMENT_VAL,
        HANDLE_THERMOMETER_SERVICE_CHAR_CFG_DESC, // char config desc handle
        HANDLE_THERMOMETER_SERVICE_CHAR_TYPE, // temperature type (location)
        HANDLE_THERMOMETER_SERVICE_CHAR_TYPE_VAL,
