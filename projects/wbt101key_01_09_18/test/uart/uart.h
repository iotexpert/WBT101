...
#define GPIO_PIN_BUTTON                 30  /* GPIO pin configured for receiving the button interrupts */
#define GPIO_PIN_LED                    26  /* GPIO pin configured for LED */

/*GPIO Settings */
#define GPIO_SETTINGS_BUTTON   GPIO_INPUT | GPIO_INIT_HIGH | GPIO_BUTTON1 | GPIO_INT
