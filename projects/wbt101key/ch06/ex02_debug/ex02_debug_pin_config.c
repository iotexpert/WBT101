#if (SMUX_CHIP == 20719)
/*
 * This file is specific to this ex01_debug app only, the default pin configuration
 * for this platform can be found in the platforms/WBT101_2_CYW920719Q40EVB_01/wiced_platform_pin_config.c
 * Please note that its mandatory to name this file in the format "ex01_debug_pin_config.c"
 */
