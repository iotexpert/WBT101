...
uint8_t ex04_ble_pass_capsense_buttons_cccd[]      = {0x00,0x00};
...
gatt_db_lookup_table ex04_ble_pass_gatt_db_ext_attr_tbl[] =
{
    ...
    {HDLD_CAPSENSE_BUTTONS_CLIENT_CONFIGURATION, 2,      2,      ex04_ble_pass_capsense_buttons_cccd},
};
...
wiced_bt_dev_status_t ex04_ble_pass_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENCRYPTION_STATUS_EVT:
        ...
        if(bond_mode == WICED_FALSE)
        {
            ...
            ex04_ble_pass_capsense_buttons_cccd[0] = hostinfo.cccd;
...
wiced_bt_gatt_status_t ex04_ble_pass_connect_callback( wiced_bt_gatt_connection_status_t *p_conn_status )
{
    ...
    if ( NULL != p_conn_status )
    {
        ...
        else
        {
            ...
            ex04_ble_pass_capsense_buttons_cccd[0] = 0;
...
void i2c_read( uint32_t arg )
{
    ...
    for(;;)
    {
        ...
        if(prevVal != buttonVal) /* Only print if value has changed since last time */
        {
            ...
            if ( connection_id != 0)
            {
                 if(ex04_ble_pass_capsense_buttons_cccd[0] & GATT_CLIENT_CONFIG_NOTIFICATION)
                {
