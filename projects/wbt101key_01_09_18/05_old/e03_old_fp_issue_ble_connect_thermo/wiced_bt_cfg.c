 ...
 ****************************************************************************/
const wiced_bt_cfg_settings_t bt_cfg_settings =
{
    ...
    .ble_advert_cfg =                                                                                // BLE advertisement settings
    {
        ...
        .high_duty_nonconn_min_interval  = 1600,                                                     // High duty non-connectable minimum advertising interval
        .high_duty_nonconn_max_interval  = 1600,                                                     // High duty non-connectable maximum advertising interval
        .high_duty_nonconn_duration      = 0,                                                        // High duty non-connectable advertising duration in seconds (0 for infinite)

        .low_duty_nonconn_min_interval   = 1600,                                                     // Low duty non-connectable minimum advertising interval
        .low_duty_nonconn_max_interval   = 1600,                                                     // Low duty non-connectable maximum advertising interval
    ...
    {
        .appearance                     = WICED_DEVICE_APPEARANCE,                                    // GATT appearance (see gatt_appearance_e)
 ...
 *****************************************************************************/
const wiced_bt_cfg_buf_pool_t bt_cfg_buf_pools[] =
{
    /*  { buf_size, buf_count } */
